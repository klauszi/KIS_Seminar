    ...
    \begin{block}{Intuitiver Ansatz von IMR}
        \begin{itemize}
            ...
            \item IMR Ansatz:
                \begin{enumerate}
                    \item Wende ARX an
                    \item Wähle Reparaturwert aus mit minimalen Abstand zur Messung
                    \item Wiederhole Prozedur
                \end{enumerate}
...
\begin{frame}[fragile]{\insertsubsection:\ ARX auf aktuelle Reparatur anwenden}
    \begin{block}{Kandidaten}
        \begin{itemize}
            ...
            \item Reparatur sind Kandidaten $\hat{y}$ (angewendetes ARX kennt vorangegangene Aktualisierung nicht)
        \end{itemize}
    \end{block}
\begin{tikzpicture}
\begin{axis}[width=.8\textwidth,
...
\begin{frame}[fragile]{\insertsubsection:\ Minimum-Change}
    \begin{block}{Minimum-Change}
        \begin{itemize}
            ...
            \item Geringste Änderung zu Messung $x$ wird als Kandidaten herangezogen
        \end{itemize}
    \end{block}
\begin{tikzpicture}
\begin{axis}[width=.8\textwidth,
...
\begin{frame}{Motivation von Matrix-Pruning IMR}
    \begin{block}{Laufzeitproblem}
        \begin{itemize}
            \item Parameterschätzung beansprucht viel Zeit 
